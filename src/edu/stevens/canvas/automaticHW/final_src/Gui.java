...
* Components on the interface: Menu Bar include Open item to open a file, Save item to save file, Quit item to quit, and all of them have shortcut for convinence.
*			       Code display is a TextArea to display the code the user choose;
*			       Result TextArea to display the result captured from terminal when compiling and runing the code;
*			       Button "run" is used after choosing a file, by clicking it, the result display will be activated and the score will display onto the grade TextField;
*			       Grade Area is a TextField and a "Save" button, it is used to display the score and modify it if the TA wants to;
*			       Comment Area is a JTextArea and a "Save" button, to input some comments and save it.
*/
...
public class Gui extends JFrame {
	...
	private JLabel codeLab, graLab, comLab, rstLab;
	...
	CodeJava java = new CodeJava();
	CodeCpp cpp = new CodeCpp();
	CodePy py = new CodePy();
	...
	Gui() {
		...
		saveItem.setShortcut(new MenuShortcut(KeyEvent.VK_S));   // Shorecut again
		...
		run.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(get(dirpath + fileName).equals("java")) {
					...
					display.setText("Please choose the .java/.cpp/.py file.");
				}
			}
		});
