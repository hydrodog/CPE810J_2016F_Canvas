...
The setGrade() and setComment() method, set the grade and comments for the particular code object. The comment is now in String format, we will try to complete it in several lines later.
