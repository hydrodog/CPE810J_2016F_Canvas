...
public class CompiledFileComparePy extends CompiledFileCompare{
	...
	public double similarity() {
		...
		compile.CompileCpp pyc1 = new compile.CompileCpp(file1);
		compile.CompileCpp pyc2 = new compile.CompileCpp(file2);
		...
		direction1 = direction1.replace(name1, "__pycache__" + name1.replace(".py", ".cpython35.pyc"));
		direction2 = direction2.replace(name2, "__pycache__" + name2.replace(".py", ".cpython35.pyc"));
