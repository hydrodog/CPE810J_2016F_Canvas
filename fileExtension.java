/*
 * This file can get all the file extensions in a folder, and compare with the canvas rules.
 * If there's any invalid file type, it can warn on the console. 
 * We will update it to emailing to student in future.
 *
 * - Shenwei Chen
 */
